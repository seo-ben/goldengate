export const FAQS = [
  ...
  {
    question: 'Comment s\'organise le règlement ? Y a-t-il une avance à verser ?',
    answer: 'Pour votre sécurité financière et notre engagement mutuel, le paiement est échelonné par étapes transparentes : un acompte au démarrage du chantier (pour l\'approvisionnement des matériaux de qualité et l\'installation), un versement intermédiaire selon l\'avancement validé ensemble, et le solde uniquement après réception finale et votre entière satisfaction des finitions.',
  ...
  {
    question: 'Combien de temps dure un chantier de faux-plafond en staff ou de peinture ?',
    answer: 'Nos délais sont rapides et respectés : comptez généralement 3 à 5 jours pour peindre entièrement un appartement ou une villa moyenne, et 5 à 7 jours pour la création complète d\'un plafond en staff avec corniches et gorges LED. Un planning précis avec date de livraison ferme est inscrit dans votre devis.',
    tag: 'Délais'
  },
  {
    question: 'Intégrez-vous directement l\'électricité, les spots et les rubans LED dans le staff ?',
    answer: 'Oui ! Nous prévoyons dès le coulage et la pose du staff les passages de câbles, les réservations pour spots encastrés et les gorges pour rubans LED indirects. Nous travaillons en coordination directe avec votre électricien ou nos propres partenaires qualifiés pour un rendu lumineux spectaculaire sans fil apparent.',
    tag: 'Éclairage & Staff'
  },
  {
